        ...
        <div className="flex gap-4">
          ...
          <dialog id="signup" className="modal">
            <div className="modal-box">
              ...
              <form action={handleSignup} className="flex flex-col items-center gap-2">
                ...
                <label htmlFor="login-password"><p>Email: </p><input type="text" name="email" value={signupUser.email} onChange={(e) => { setSignupUser({ ...signupUser, password: e.target.value }) }} /></label>
                <label htmlFor="login-password"><p>Password: </p><input type="text" name="password" value={signupUser.password} onChange={(e) => { setSignupUser({ ...signupUser, password: e.target.value }) }} /></label>
